...
public class MutualFundsRequest {
	...
	private int current_net_asset_value;

	public MutualFundsRequest() {
	}

	public MutualFundsRequest(String createdDateTime, String updatedDateTime, int id, String name, String code,
			String amc_code, String isin, String logo, int per_share, int market_value, int week_high, int week_low,
			int min_ltv, int max_ltv, int week_perf, int lendors_loan_offer, String low_achieved, String high_achieved,
			String one_week, String one_month, String one_months, String one_year, String createdBy, String updatedBy,
			int type, String scheme, int current_net_asset_value) {
		super();
		...
		this.type = type;
		this.scheme = scheme;
		this.current_net_asset_value = current_net_asset_value;
	}

		// Optionally, a shorter constructor (for testing without timestamps)
	public MutualFundsRequest(int id, String name, String code, int per_share, int market_value, String createdBy,
			int type, int current_net_asset_value) {
		this.id = id;
		this.name = name;
		this.code = code;
		this.per_share = per_share;
	...
	public int getCurrent_net_asset_value() {
		return current_net_asset_value;
	}
	...
	public void setCurrent_net_asset_value(int current_net_asset_value) {
		this.current_net_asset_value = current_net_asset_value;
	}
